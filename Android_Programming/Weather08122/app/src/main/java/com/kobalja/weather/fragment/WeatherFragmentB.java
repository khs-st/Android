...
public class WeatherFragmentB extends Fragment {
    Button getBWeather;
    TextView showBWeather;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ViewGroup rootView = (ViewGroup) inflater.inflate(R.layout.fragment_weather_b,
                container, false);
        //fragment layout 연결
        getBWeather = rootView.findViewById(R.id.startweather2);
        showBWeather = rootView.findViewById(R.id.weatherinfo2);
